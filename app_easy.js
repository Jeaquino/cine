    ...
    switch (req.url) {
        ...
        case '/':
            ...
            movies.forEach(function(movie){
                titulosOrdenados.push(movie.title)
            })
            titulosOrdenados.sort();
            titulosOrdenados.forEach(function(titulo){
                res.write(titulo)
                res.write("\n")
            })
        ...
        case '/en-cartelera':
            ...
            let peliculasConReseña = movies

            peliculasConReseña.sort(function(a,b){
                return ((a.title < b.title) ? -1 : ((a.title > b.title) ? 1 : 0));
            })

            peliculasConReseña.forEach(function(peli){
                res.write("\n\n\n")
                res.write("•" + peli.title)
                res.write("\n")
                res.write("•" + peli.overview)
            })
        ...
        case '/mas-votadas':
            ...
            let peliculasMasVotadas = movies.filter(movie => movie.vote_average >=7)
            
            peliculasMasVotadas.sort(function(a,b){
                return ((a.title < b.title) ? -1 : ((a.title > b.title) ? 1 : 0));
            })

            res.write("\n\nTotal de peliculas: " + peliculasMasVotadas.length)
            let promedio = 0 
            peliculasMasVotadas.forEach(function(peli){
                promedio = promedio + peli.vote_average
            })
            promedio = promedio/peliculasMasVotadas.length
